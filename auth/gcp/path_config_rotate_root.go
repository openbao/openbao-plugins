...
func pathConfigRotateRoot(b *GcpAuthBackend) *framework.Path {
...
func (b *GcpAuthBackend) pathConfigRotateRootWrite(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	...
	return &logical.Response{
		Data: map[string]interface{}{
			"private_key_id": cfg.Credentials.PrivateKeyId,
		},
	}, nil
}

func (b *GcpAuthBackend) rotateRootCredential(ctx context.Context, req *logical.Request) error {
